...
//         className="mb-4 justify-content-center tab-buttons onsite"
//         fill
//       >
          ...
          <Tab eventKey={key} title={title} key={key}>
            ...
            >
              <div className="col-md-6 mb-3 mb-md-0 text-md-start text-center">
                <p className="text-muted">{description}</p>
                {steps.map(([stepTitle, stepDesc], idx) => (
                  <div key={idx} className="d-flex align-items-start mb-3 text-start text-md-start justify-content-center justify-content-md-start">
                    <span className="badge step-badge me-3">{idx + 1}</span>
                    <div>
                      <h6 className="fw-bold mb-1">{stepTitle}</h6>
                      <p className="text-muted small mb-0">{stepDesc}</p>
