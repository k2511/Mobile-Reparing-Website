...
//   const hamburgerRef = useRef(null); // ✅ new ref
...
//         !hamburgerRef.current.contains(event.target) && // ✅ don’t close when clicking hamburger
//         !isNavCollapsed
//       ) {
...
//         /* ✅ Media query for large devices (≥992px) */
...
//         /* ✅ Media query for small devices (<992px) */
//         @media (max-width: 991px) {
//   .d-flex {
//     min-height: 65px; /* smaller navbar */
//     padding-top: 0 !important;
//     padding-bottom: 0 !important;
//   }
//   .logo img {
