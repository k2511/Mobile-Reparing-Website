...
//             setUserLocation(address);      // textarea shows this
//             setDetectedAddress(address);   // used for submission (unless user edits)
...
//     // Use detectedAddress (if present and user didn't edit) else textarea value
...
//     // Prevent submitting status/error messages as the address
...
//     // Open WhatsApp with only the formatted address (no coords)
//     window.open(
