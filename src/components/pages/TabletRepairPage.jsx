...
const TabletRepairPage = () => {
  ...
  const tabletModels = [
    { name: "Apple iPad Pro 12.9", image: tablet1 },
    { name: "Apple iPad Air", image: tablet2 },
    { name: "Samsung Galaxy Tab S9", image: tablet3 },
    { name: "Samsung Galaxy Tab A8", image: tablet4 },
    { name: "Microsoft Surface Pro 9", image: tablet5 },
    { name: "Microsoft Surface Go 3", image: tablet6 },
    { name: "Lenovo Tab P12 Pro", image: tablet7 },
    { name: "Huawei MatePad Pro", image: tablet8 },
    { name: "Amazon Fire HD 10", image: tablet9 },
    { name: "Xiaomi Pad 6", image: tablet10 },
  ];
