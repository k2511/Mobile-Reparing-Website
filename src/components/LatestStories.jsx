        ...
        <Slider {...settings}>
          {stories.map((story, idx) => (
            <div key={idx} className="px-2">
              <Card
                className="shadow border-0 d-flex flex-column"
                style={{
                  height: "100%",
                  minHeight: "420px",
                  borderRadius: "12px",
...
//                 {/* Card body with fixed text area */}
//                 <Card.Body
...
//         .slick-dots {
//           margin-top: 20px; /* Move dots below carousel */
//         }
...
//           .card {
//             width: 300px !important; /* Adjust for mid-size screens */
//           }
//         }

//         @media (max-width: 576px) {
//           .card {
//             width: 280px !important; /* Adjust for mobile */
//           }
//         }
//       `}</style>
//     </section>
