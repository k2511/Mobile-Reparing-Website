...
const msiModels = [
  { id: 1, name: "MSI GS66 Stealth", issue: "Screen Replacement, Battery Repair" },
  { id: 2, name: "MSI GE76 Raider", issue: "GPU Repair, Cooling System Replacement" },
  { id: 3, name: "MSI Modern 14", issue: "Keyboard Replacement, RAM Upgrade" },
];
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
      ...
      <section style={{ textAlign: "center", padding: "40px" }}>
        <img src={Msi} alt="MSI" style={{ maxWidth: "150px", marginBottom: "20px" }} />
        <p style={{ maxWidth: "800px", margin: "0 auto", color: "#6c757d" }}>
          MSI laptops are built for gaming and high-performance tasks. We provide professional repair services,
          including screen replacement, battery repair, GPU repair, and more.
        </p>
      </section>
