...
const samsungModels = [
  { id: 1, name: "Samsung Galaxy Book Pro", issue: "Screen Replacement, Battery Repair" },
  { id: 2, name: "Samsung Notebook 9", issue: "Keyboard Replacement, RAM Upgrade" },
  { id: 3, name: "Samsung Galaxy Book 2", issue: "Motherboard Repair, SSD Upgrade" },
];
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
      ...
      <section style={{ textAlign: "center", padding: "40px" }}>
        <img src={Samsung} alt="Samsung" style={{ maxWidth: "150px", marginBottom: "20px" }} />
        <p style={{ maxWidth: "800px", margin: "0 auto", color: "#6c757d" }}>
          Samsung laptops are designed for performance and portability. Our expert repair services cover
          screen replacement, battery repair, keyboard repair, and more.
        </p>
      </section>
