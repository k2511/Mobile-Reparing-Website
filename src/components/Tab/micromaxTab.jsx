...
const MicromaxTab = () => {
  ...
  const defaultBrandImage = "https://via.placeholder.com/150x150?text=Micromax+Tablet";
  ...
  // Default Micromax tablet models
  const micromaxModels = [
    { id: 1, name: "Micromax Canvas Tab P702", image: "https://via.placeholder.com/150x150?text=Canvas+Tab+P702" },
    { id: 2, name: "Micromax Canvas Tab P681", image: "https://via.placeholder.com/150x150?text=Canvas+Tab+P681" },
    ...extraModels
      .filter((model) => !["Micromax Canvas Tab P702", "Micromax Canvas Tab P681"].includes(model))
      .map((model, index) => ({
        id: index + 3,
        name: model,
        image: brandImage,
  ...
  const filteredModels = micromaxModels.filter((m) =>
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ backgroundColor: "white", border: "1px solid #dee2e6", borderRadius: "10px", padding: "40px", textAlign: "center", marginTop: "40px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: "bold", marginBottom: "20px" }}>MICROMAX REPAIR & REPLACEMENT</h2>
          <p style={{ color: "#6c757d", lineHeight: "1.6", maxWidth: "800px", margin: "0 auto" }}>
            Micromax tablets are designed for reliable performance. Our repair & replacement services ensure fast turnaround, genuine parts, and expert care for your device.
          </p>
          <h3 style={{ fontSize: "18px", fontWeight: "600", marginTop: "30px" }}>WE CAN FIX YOUR MICROMAX DEVICE</h3>
        </div>
      </div>
    </div>
  );
