...
const AsusTab = () => {
  ...
  const defaultBrandImage = "https://via.placeholder.com/150x150?text=Asus+Tablet";
  ...
  const asusModels = [
    { id: 1, name: "Asus ZenPad 10", image: "https://via.placeholder.com/150x150?text=Asus+ZenPad+10" },
    { id: 2, name: "Asus ZenPad 8", image: "https://via.placeholder.com/150x150?text=Asus+ZenPad+8" },
    ...extraModels
      .filter((model) => !["Asus ZenPad 10", "Asus ZenPad 8"].includes(model))
      .map((model, index) => ({
        id: index + 3,
        name: model,
        image: brandImage,
  ...
  const filteredModels = asusModels.filter((m) =>
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ backgroundColor: "white", border: "1px solid #dee2e6", borderRadius: "10px", padding: "40px", textAlign: "center", marginTop: "40px" }}>
          <h2 style={{ fontSize: "24px", fontWeight: "bold", marginBottom: "20px" }}>ASUS REPAIR & REPLACEMENT</h2>
          <p style={{ color: "#6c757d", lineHeight: "1.6", maxWidth: "800px", margin: "0 auto" }}>
            Asus tablets are designed for performance and productivity. Our repair & replacement services provide fast turnaround, genuine parts, and reliable performance for your device.
          </p>
          <h3 style={{ fontSize: "18px", fontWeight: "600", marginTop: "30px" }}>WE CAN FIX YOUR ASUS DEVICE</h3>
        </div>
      </div>
    </div>
  );
