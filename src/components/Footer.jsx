      ...
      <Container fluid="lg" className="pt-4 pt-lg-5">
        ...
        <Row className="gy-3 gy-md-5 mb-3 mb-lg-5 align-items-start justify-content-between">
          ...
          <Col
            xs={12}
            lg={3}
            className="text-center text-lg-start footer-brand mb-3 mb-lg-0"
          >
            <h4 className="fw-bold mb-2 mb-lg-3" style={{ color: "#ff4d4d" }}>
              Screen Guru
            </h4>
            ...
            <div className="d-flex justify-content-center justify-content-lg-start gap-3 mt-3 social-wrap">
              ...
              <a
                href="https://www.google.com/maps/place/Screenguru:+Affordable+Phone,+Watch+%26+Tab+Repairs+at+Your+Doorstep!+(6+Months+Warranty)/@12.9644934,77.5840211,17z/data=!3m1!4b1!4m6!3m5!1s0x3bae15835458b8e3:0x864090ff055cec15!8m2!3d12.9644934!4d77.5840211!16s%2Fg%2F11vwpqrv5q?entry=ttu&g_ep=EgoyMDI1MDkyNC4wIKXMDSoASAFQAw%3D%3D"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon"
                aria-label="google"
          ...
          <Col
            ...
            md={3}
            lg={2}
            className="text-center text-md-start mb-3 mb-lg-0"
          >
            <h5 className="fw-bold mb-2 mb-lg-3">Services</h5>
            <ul className="list-unstyled small list-links">
              <li className="mb-2">
                <Link to="/mobile-repair" className="footer-link">
                  Phones
                </Link>
              </li>
              <li className="mb-2">
                <Link to="/tablet-repair" className="footer-link">
                  Tablet
                </Link>
              </li>
              <li className="mb-2">
                <Link to="/watch-repair" className="footer-link">
                  Smart Watches
                </Link>
              </li>

                <li className="mb-2">
                <Link to="/macbook-repair" className="footer-link">
                  Laptop
                </Link>
              </li>

                <li className="mb-2">
                <Link to="/buyphones" className="footer-link">
                  Buy Phones
                </Link>
              </li>
              <li className="mb-2">
                <Link to="/mobile-accessories" className="footer-link">
                  Mobile Accessories
                </Link>
              </li>
            </ul>
          ...
          >
            ...
            <ul className="list-unstyled small list-links">
              ...
              <li className="mb-2">
                <Link to="/warranty-policy" className="footer-link">
                  Warranty Policy
                </Link>
              </li>
              <li className="mb-2">
