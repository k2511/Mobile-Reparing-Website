// App.js (corrected: prioritized routes for laptop models to IssueLaptop; specific brand pages follow; added missing imports where needed; cleaned up commented code; ensured BuyPhones route is included)
import React, { Suspense } from "react";
import { Routes, Route, Outlet } from "react-router-dom";
import { Helmet } from "react-helmet";

import IssueBrand from "./components/offer/IssueBrand.jsx";
...
import CookieBanner from "./components/offer/CookieBanner.jsx";
...
const IphonePage = React.lazy(() => import("./components/brands/IphonePage.jsx"));
...
import MacbookLap from "./components/Laptop/MacbookLap.jsx";
...
import IssueLaptop from "./components/offer/IssueLaptop.jsx";
import BuyPhones from "./components/pages/BuyPhones.jsx";
  ...
  return (
    <Routes>
      <Route element={<MainLayout />}>
        ...
        <Route path="/laptop-repair" element={<LaptopPage />} />
        ...
        {/* Laptop Routes - PRIORITIZED: Model-specific issues route first (catches /laptops/:brand/:model) */}
        <Route path="/laptops/:brand/:model" element={<IssueLaptop />} />
        {/* Specific brand pages (match /laptops/:brand, AFTER model route) */}
        <Route path="/laptops/apple" element={<MacbookLap />} />
        ...
        {/* Optional: Dynamic fallback for unknown brands (matches /laptops/:brand if not specific) */}
        ...
        {/* Special Offer Route */}
        <Route path="/issue-brand" element={<IssueBrand />} />
      </Route>
    </Routes>
  );
};
