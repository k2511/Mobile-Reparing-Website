...
//         {/* laptop Issues */}
//         {/* Laptop Issue Page (for all brands) */}
//         <Route path="/laptops/:laptopName" element={<IssueLaptop />} />
//       </Route>
//     </Routes>
//   );
// };
  ...
  return (
    <Routes>
      <Route element={<MainLayout />}>
        ...
        <Route path="/tablets/microsoft" element={<MicrosoftTab />} />
        <Route path="/tablets/micromax" element={<MicromaxTab />} />
        {/* Laptop Routes - PRIORITIZED: Dynamic IssueLaptop route first to catch all /laptops/:laptopName */}
        {/* (This will match before specific brand routes, rendering IssueLaptop for e.g., /laptops/dell) */}
        <Route path="/laptops/:laptopName" element={<IssueLaptop />} />
        {/* If you want to keep specific brand pages for some reason, add them BELOW this dynamic route (they won't be hit for /laptops/:something) */}
        {/* <Route path="/laptops/:brand" element={<LaptopBrandPage />} /> */}
        {/* <Route path="/laptops/dell" element={<DellLap />} /> */}
        {/* <Route path="/laptops/apple" element={<MacbookLap />} /> */}
        {/* <Route path="/laptops/hp" element={<HPLap />} /> */}
